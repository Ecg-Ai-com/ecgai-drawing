...
def random_noise(image, mode="gaussian", seed=None, clip=True, **kwargs):
    ...
    if mode == "gaussian":
        ...
        out = random_noise(image, mode="s&p", seed=rng, amount=kwargs["amount"], salt_vs_pepper=1.0)

    elif mode == "pepper":
        # Re-call function with mode='s&p' and p=1 (all pepper noise)
        out = random_noise(image, mode="s&p", seed=rng, amount=kwargs["amount"], salt_vs_pepper=0.0)
